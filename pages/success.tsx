        ...
        <main className="grid grid-cols-1 lg:grid-cols-9">
            <section className="order-2 lg:col-span-5 mx-auto max-w-xl pb-12 lg:mx-0 lg:max-w-none lg:pr-16 lg:pt-16 xl:pl-16 2xl:pl-44">
                ...
                <div className="my-8 ml-4 flex space-x-4 lg:ml-14 xl:ml-0">
                    ...
                    <div>
                        <p className="text-sm text-gray-600">Order #{session_id?.slice(-15)}</p>
            ...
            {mounted && (
                <section className="overflow-y-scroll border-y border-l border-gray-300 bg-[#F1FAFA] lg:order-2 lg:col-span-4 lg:h-screen lg:border-y-0">
                        ...
                        <div className="mx-auto max-w-xl divide-y border-gray-300 px-4 py-4 lg:mx-0 lg:max-w-lg lg:px-10 lg:py-16">
                            <div className="space-y-4 pb-4">
                                {products.map((product) => (
                                    <div key={product.id} className="flex items-center space-x-4 text-medium">
                            ...
                            <div className="space-y-1 py-4">
                                ...
                                <div className="flex justify-between text-sm">
                                    ...
                                    <p className="font-semibold">
                                        <Currency quantity={150} currency="INR" />
                                    </p>
                                </div>
                            </div>
                            <div className="flex justify-between pt-4">
                                ...
                                <p className="flex items-center gap-x-2 text-xs text-[gray]">
                                    ...
                                    <span className="text-xl font-medium text-black">
                                        <Currency quantity={subtotal + 150} currency="INR" />
                                    </span>
                                </p>
                            </div>
                        </div>
